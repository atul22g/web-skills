...
export class App extends LitElement {
	...
	render () {
		...
		return html`
			...
			<header id="header">
				<div>
					<a href="https://github.com/atul22g/web-skills" target="_blank" rel="noopener" aria-label="Open Github" title="Open Github">
				...
				<div>
					...
					<a aria-label="Open author" href="https://atul22g.netlify.app" target="_blank" rel="noopener" title="Say hi">
			...
			<footer id="footer">
				<div>
					...
					`}
					<a href="https://github.com/atul22g/web-skills/stargazers" target="_blank" aria-label="Become a stargazer" rel="noopener">
